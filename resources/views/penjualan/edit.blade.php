...
<div class="max-w-4xl mx-auto">
 ...
 <!-- ID Penjualan -->
 <div class="space-y-2">
 <label class="block text-xs font-semibold text-gray-500 mb-2">ID Penjualan</label>
 <input type="text" value="{{ $penjualan->ID_Penjualan }}" class="w-full bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-500 cursor-not-allowed" readonly>
 </div>
 ...
 <!-- Kuantitas -->
 <div class="space-y-2">
 <label class="block text-xs font-semibold text-gray-500 mb-2">Kuantitas Penjualan</label>
