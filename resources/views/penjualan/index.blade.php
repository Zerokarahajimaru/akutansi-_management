...
<div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_8px_30px_rgb(13,148,136,0.04)]">
 ...
 <a href="{{ route('util.template', 'penjualan') }}" class="w-full sm:w-auto bg-slate-100 text-slate-600 border border-slate-200 hover:bg-slate-200 font-bold rounded-xl px-4 py-2.5 text-xs transition-all flex items-center justify-center">
             ...
             <form action="{{ route('util.import', 'penjualan') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                 ...
                 <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2">
                     ...
                     <button type="submit" class="w-full sm:w-auto bg-teal-600 text-white font-black rounded-xl shadow-lg shadow-teal-500/20 hover:bg-teal-700 hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 px-5 py-2.5 text-sm group flex items-center justify-center">
                        ...
                        <i class="fas fa-arrow-right text-[10px] ml-2 group-hover:translate-x-1 transition-transform ml-1"></i>
                     </button>
                 </div>
             </form>
         </div>
 ...
 <a href="{{ route('util.export', 'penjualan') }}" class="w-full sm:w-auto bg-slate-100 text-slate-600 border border-slate-200 hover:bg-slate-200 font-bold rounded-xl px-4 py-2.5 text-xs transition-all flex items-center justify-center">
 <i class="fas fa-file-export mr-2"></i> Ekspor Excel
 </a>
 <a href="{{ route('input.penjualan') }}" wire:navigate.hover class="w-full sm:w-auto bg-teal-600 text-white font-black rounded-xl shadow-lg shadow-teal-500/20 hover:bg-teal-700 hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 px-4 py-2.5 text-xs flex items-center justify-center">
 ...
 <a href="{{ route('data.penjualan.edit', $item->ID_Penjualan) }}" wire:navigate.hover class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-50 text-teal-600 hover:bg-teal-600 hover:text-white shadow-sm transition-all" title="Ubah Data">
