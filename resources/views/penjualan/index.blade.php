...
<div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_8px_30px_rgb(13,148,136,0.04)]">
 ...
 <a href="{{ route('util.template', 'penjualan') }}" class="bg-slate-100 text-slate-600 border border-slate-200 hover:bg-slate-200 font-bold rounded-xl px-4 py-2 text-xs transition-all flex items-center">
 ...
 <a href="{{ route('util.export', 'penjualan') }}" class="bg-slate-100 text-slate-600 border border-slate-200 hover:bg-slate-200 font-bold rounded-xl px-4 py-2 text-xs transition-all flex items-center">
