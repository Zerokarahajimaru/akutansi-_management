...
<div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(15,23,42,0.04)] border border-slate-100">
 ...
 <a href="{{ route('util.template', 'penjualan') }}" class="bg-slate-100 text-slate-600 border border-slate-200 font-bold rounded-xl px-4 py-2 text-xs hover:bg-slate-200 transition-all flex items-center">
 ...
 <a href="{{ route('util.export', 'penjualan') }}" class="bg-slate-100 text-slate-600 border border-slate-200 font-bold rounded-xl px-4 py-2 text-xs hover:bg-slate-200 transition-all flex items-center">
 <i class="fas fa-file-export mr-2"></i> Ekspor Excel
 </a>
 <a href="{{ route('input.penjualan') }}" wire:navigate.hover class="bg-teal-600 text-white font-black rounded-xl shadow-lg shadow-teal-500/20 hover:bg-teal-700 hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 px-4 py-2 text-xs flex items-center">
 ...
 <td class="py-4 px-6 text-sm text-slate-600 font-medium">{{ date('d/m/Y', strtotime($item->Tanggal_Penjualan)) }}</td>
 <td class="py-4 px-6">
