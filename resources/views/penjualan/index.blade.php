...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
 ...
 <a href="{{ route('input.penjualan') }}" class="flex items-center px-4 py-2 bg-red-600 text-white rounded-xl text-xs font-bold hover:bg-red-700 transition-colors shadow-lg shadow-red-200">
 ...
 <a href="{{ route('data.penjualan.edit', $item->ID_Penjualan) }}" class="flex items-center justify-center w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white transition-colors">
 ...
 @empty
 <tr>
 <td colspan="{{ Auth::user()->role === 'admin' ? 9 : 8 }}" class="py-10 text-center text-gray-400 italic text-sm">Belum ada data penjualan</td>
 </tr>
 @endforelse
 </tbody>
 </table>
