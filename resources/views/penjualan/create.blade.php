        ...
        <form action="{{ route('input.penjualan') }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2" x-data="{ 
                    ...
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Pelanggan <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <!-- Tanggal -->
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Tanggal Penjualan <span class="text-red-500">*</span></label>
                ...
                <!-- Kuantitas -->
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Kuantitas Penjualan <span class="text-red-500">*</span></label>
