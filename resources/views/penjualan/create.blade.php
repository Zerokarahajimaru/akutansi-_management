...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl border border-slate-100 shadow-[0_20px_50px_rgba(13,148,136,0.05)] overflow-hidden">
        <div class="p-8 border-b border-slate-50">
            <h2 class="text-xl font-black text-slate-800 tracking-tight">Catat Penjualan Baru</h2>
        ...
        <form action="{{ route('input.penjualan') }}" method="POST" class="p-8 space-y-6" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2" x-data="{ 
                    ...
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Pilih Produk <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <div class="space-y-2" x-data="{ 
                    ...
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Pelanggan <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <!-- Tanggal -->
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Tanggal Penjualan <span class="text-red-500">*</span></label>
                ...
                <!-- Kuantitas -->
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Kuantitas Penjualan <span class="text-red-500">*</span></label>
                ...
                <!-- Ongkir -->
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Ongkos Kirim (Rp) <span class="text-red-500">*</span></label>
