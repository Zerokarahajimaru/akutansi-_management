...
<div class="max-w-4xl mx-auto">
 ...
 <button type="submit" class="px-10 py-3 bg-red-600 text-white rounded-xl text-sm font-bold hover:bg-red-700 transition-all shadow-lg shadow-red-200">Simpan Penjualan</button>
 </div>
 </form>
 </div>
</div>
