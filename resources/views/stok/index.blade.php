...
<div class="bg-white rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgba(13,148,136,0.05)]">
    ...
    <div class="p-6 border-b border-slate-50">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
                <h2 class="font-black text-[#ca5b33] text-lg tracking-tight">Master Stok Barang</h2>
        ...
        <div class="flex flex-col xl:flex-row justify-between items-center gap-4 mb-6 w-full">
            ...
            <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                ...
                <div class="flex items-center bg-slate-100 border border-slate-200 rounded-xl shadow-sm w-full sm:w-auto divide-x divide-slate-200 overflow-hidden">
                    <!-- Unduh Template -->
                    <a href="{{ route('util.template', 'stok') }}" class="flex-1 lg:flex-none flex items-center justify-center px-3 py-2 text-[9px] font-black uppercase tracking-widest text-slate-500 hover:bg-white hover:text-slate-800 transition-all" title="Unduh Template Excel">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="relative z-0">
                                                ...
                                                <p id="fileNameStok" class="text-xs font-bold text-slate-800 mt-3 truncate"></p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <tr class="group bg-white even:bg-white even:text-white hover:bg-[#A98D66]/20 transition-all duration-200">
                    ...
                    <td class="py-5 px-8">
                        <div class="flex justify-center items-center gap-2">
                            <a href="{{ route('data.barang.edit', $stok->ID_Barang) }}" wire:navigate.hover class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-50 text-slate-800 hover:bg-[#3B8A7F] hover:text-white shadow-sm transition-all" title="Edit Stok">
                                <i class="fas fa-edit text-xs"></i>
                            </a>
                            <form action="{{ route('data.barang.destroy', $stok->ID_Barang) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="w-8 h-8 rounded-lg bg-white/10 text-[#B04025] hover:bg-white hover:text-white shadow-sm transition-all" title="Hapus Stok">
