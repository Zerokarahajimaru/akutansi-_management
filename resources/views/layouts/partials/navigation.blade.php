<nav class="mt-2 flex-1 overflow-y-auto overflow-x-hidden px-4 space-y-1 pb-10">
 <p x-show="sidebarOpen" class="text-gray-400 text-xs font-semibold px-4 mb-2 mt-6 uppercase tracking-wider">Menu Utama</p>
 ...
 <p x-show="sidebarOpen" class="text-gray-400 text-xs font-semibold px-4 mb-2 mt-8 uppercase tracking-wider">Manajemen Sistem</p>
 ...
 <p x-show="sidebarOpen" class="text-gray-400 text-xs font-semibold px-4 mb-2 mt-8 uppercase tracking-wider">Analisis & Laporan</p>
