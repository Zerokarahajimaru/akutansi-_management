...
<div class="max-w-4xl mx-auto">
 ...
 <p class="text-slate-500 text-sm mt-1 text-center">Perbarui informasi transaksi stok masuk untuk ID: <span class="font-mono font-bold text-slate-800">{{ $pembelian->ID_Pembelian }}</span></p>
 </div>
 ...
 @if(session('error'))
 <div class="bg-white/10 text-[#B04025] p-4 rounded-xl text-sm font-medium border border-[#B04025]/20">
 {{ session('error') }}
 </div>
 @endif
 ...
 <button @click="open = !open" type="button" class="w-full bg-white border border-slate-200 text-slate-800 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-[#3B8A7F]/10 focus:border-[#3B8A7F] transition-all duration-300 flex items-center justify-between @error('ID_Barang') border-rose-300 focus:ring-rose-500/10 focus:border-rose-500 @enderror">
 ...
 :class="selected === option.val ? 'text-slate-800 font-bold bg-[#A98D66]/10' : ''">
 ...
 <button @click="open = !open" type="button" class="w-full bg-white border border-slate-200 text-slate-800 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-[#3B8A7F]/10 focus:border-[#3B8A7F] transition-all duration-300 flex items-center justify-between @error('ID_Pemasok') border-rose-300 focus:ring-rose-500/10 focus:border-rose-500 @enderror">
 <span x-text="selectedLabel" :class="selected === '' ? 'text-slate-400' : 'font-medium'"></span>
 <i class="fas fa-chevron-down text-slate-400 text-[10px] transition-transform" :class="open ? 'rotate-180' : ''"></i>
 </button>
 ...
 class="px-4 py-2.5 text-sm cursor-pointer transition-colors flex items-center justify-between group hover:bg-[#A98D66]/10 hover:text-[#2F5C53] text-slate-800"
 :class="selected === option ? 'text-slate-800 font-bold bg-[#A98D66]/10' : ''">
 ...
 <button type="submit" 
    ...
    class="bg-[#3B8A7F] text-white font-black rounded-xl px-10 py-3 text-sm hover:bg-white shadow-lg shadow-[#3B8A7F]/20 hover:-translate-y-0.5 active:scale-95 transition-all duration-300">
