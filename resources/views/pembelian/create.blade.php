        ...
        <form action="{{ route('input.pembelian') }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2" x-data="{ 
                    ...
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Pilih Produk <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <div class="space-y-2" x-init="$watch('selected', value => { window.dispatchEvent(new CustomEvent('pemasok-changed', { detail: value })) })" x-data="{ 
                    ...
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Pemasok <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <!-- Tanggal -->
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Tanggal Pembelian <span class="text-red-500">*</span></label>
                ...
                <!-- Kuantitas -->
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Kuantitas Pembelian <span class="text-red-500">*</span></label>
                ...
                <!-- Ongkir -->
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Ongkos Kirim (Rp) <span class="text-red-500">*</span></label>
            ...
            <div class="pt-6 border-t border-slate-50 flex justify-end space-x-3">
                <a href="{{ route('data.pembelian') }}" class="px-6 py-3 bg-slate-50 text-slate-400 border border-slate-200 rounded-xl text-sm font-bold hover:bg-slate-100 hover:text-slate-600 transition-all">Batal</a>
