        ...
        <form action="{{ route('input.pembelian') }}" method="POST" class="p-8 space-y-6" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2" x-init="$watch('selected', value => { window.dispatchEvent(new CustomEvent('pemasok-changed', { detail: value })) })" x-data="{ 
                    ...
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Pemasok <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <!-- Tanggal -->
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Tanggal Pembelian <span class="text-red-500">*</span></label>
                ...
                <!-- Kuantitas -->
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Kuantitas Pembelian <span class="text-red-500">*</span></label>
