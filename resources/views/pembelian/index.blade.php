...
@section('content')
<div class="bg-white rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgba(59,138,127,0.05)]">
 <!-- Action Bar -->
 <div class="p-6 border-b border-slate-50">
 <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
 <div>
 <h2 class="font-black text-[#ca5b33] text-lg tracking-tight">Data Transaksi Pembelian</h2>
 ...
 <th class="py-4 px-6 whitespace-nowrap">Data Pemasok</th>
 ...
 <a href="{{ route('data.pembelian.edit', $item->ID_Pembelian) }}" wire:navigate class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-50 text-slate-800 hover:bg-[#3B8A7F] hover:text-white shadow-sm transition-all" title="Ubah Data">
