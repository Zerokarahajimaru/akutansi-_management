...
<div class="max-w-2xl mx-auto">
 ...
 <input type="text" name="Nama_Pelanggan" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 transition-all duration-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 hover:border-slate-300" required>
 </div>
 <div>
 <label class="block text-xs font-semibold text-slate-500 mb-2">No. HP Pelanggan <span class="text-red-500">*</span></label>
 <input type="text" name="NoTelp_Pelanggan" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 transition-all duration-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 hover:border-slate-300" required>
 </div>
 <div>
 <label class="block text-xs font-semibold text-slate-500 mb-2">Alamat Pelanggan <span class="text-red-500">*</span></label>
 <textarea name="Alamat_Pelanggan" rows="3" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 transition-all duration-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 hover:border-slate-300" required></textarea>
 </div>
