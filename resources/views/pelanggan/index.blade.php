...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
    <div class="p-6 border-b border-slate-50 flex items-center justify-between">
        <h2 class="font-bold text-slate-800">Daftar Pelanggan</h2>
        <a href="{{ route('input.pelanggan') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-xl text-xs font-bold hover:bg-indigo-700 transition-colors">Tambah Pelanggan</a>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr>
                    <td class="py-4 px-6 text-xs text-slate-400 font-mono">{{ $p->ID_Pelanggan }}</td>
