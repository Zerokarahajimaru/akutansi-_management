...
<div class="max-w-2xl mx-auto">
 ...
 @method('PUT')
 <div>
 <label class="block text-xs font-semibold text-gray-500 mb-2">ID Pemasok</label>
 <input type="text" value="{{ $pemasok->ID_Pemasok }}" class="w-full bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-500 cursor-not-allowed" readonly>
 </div>
 <div>
 ...
 <div>
 <label class="block text-xs font-semibold text-gray-500 mb-2">No. HP Pemasok</label>
 ...
 <div>
 <label class="block text-xs font-semibold text-gray-500 mb-2">Alamat Pemasok</label>
