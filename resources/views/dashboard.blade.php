...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <!-- Penjualan Card -->
        <div class="bg-white p-8 rounded-2xl shadow-[0_8px_30px_rgba(202,91,51,0.05)] border border-slate-100 flex items-center justify-between group hover:border-[#ca5b33]/30 transition-all duration-300">
            <div>
            ...
            <div class="w-14 h-14 bg-[#A98D66]/10 rounded-xl flex items-center justify-center transition-all duration-300 border border-[#A98D66]/20">
                <i class="fas fa-hand-holding-dollar text-xl text-[#000000]"></i>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-[0_8px_30px_rgba(202,91,51,0.05)] border border-slate-100 flex items-center justify-between group hover:border-[#ca5b33]/30 transition-all duration-300">
            ...
            <div class="w-14 h-14 bg-[#A98D66]/10 rounded-xl flex items-center justify-center transition-all duration-300 border border-[#A98D66]/20">
                <i class="fas fa-cart-shopping text-xl text-[#000000]"></i>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-[0_8px_30px_rgba(202,91,51,0.05)] border border-slate-100 flex items-center justify-between group hover:border-[#ca5b33]/30 transition-all duration-300">
            ...
            <div class="w-14 h-14 bg-[#A98D66]/10 rounded-xl flex items-center justify-center transition-all duration-300 border border-[#A98D66]/20">
                <i class="fas fa-box-open text-xl text-[#000000]"></i>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-[0_8px_30px_rgba(202,91,51,0.05)] border border-slate-100 overflow-hidden">
            ...
            <div class="overflow-x-auto custom-scrollbar relative">
                <table class="w-full text-left">
                    <thead>
                        <tr class="bg-white text-[#000000] text-[10px] font-black uppercase tracking-widest whitespace-nowrap border-b-2 border-[#B04025]">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="bg-white hover:bg-[#A98D66]/10 transition-all group">
                            <td class="py-4 px-8 text-xs text-slate-500 font-medium whitespace-nowrap sticky left-0 bg-white z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] group-hover:bg-[#A98D66]/5 transition-colors">{{ $act['date'] }}</td>
        ...
        <!-- Critical Stocks -->
        <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgba(202,91,51,0.05)] border border-slate-100 overflow-hidden flex flex-col self-start">
            <div class="p-6 border-b border-slate-50 bg-slate-50/30">
                <h2 class="font-black text-[#B04025] text-[11px] uppercase tracking-widest flex items-center">
                    <i class="fas fa-triangle-exclamation mr-2 text-[#B04025]"></i> Stok Kritis
                </h2>
            </div>
