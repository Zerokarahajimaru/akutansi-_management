...
<div class="max-w-2xl mx-auto">
 ...
 <h2 class="font-bold text-gray-800 text-xl">Ubah Pengguna</h2>
 ...
 <!-- Username -->
 <div class="space-y-2">
 <label class="block text-xs font-semibold text-gray-500 mb-2">Username (Permanen)</label>
 <input type="text" name="username" value="{{ old('username', $user->username) }}" class="w-full bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-400 cursor-not-allowed" readonly title="Username tidak dapat diubah">
