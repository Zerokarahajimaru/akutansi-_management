...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
 ...
 <div>
 <h2 class="font-bold text-gray-800 text-lg">Laporan Pembelian Stok</h2>
 <p class="text-gray-500 text-xs">Analisa riwayat pengadaan barang dari pemasok</p>
 </div>
 ...
 <h3 class="text-xl font-bold text-gray-800">{{ $pembelians->count() }}</h3>
 </div>
 <div class="p-6 border-r border-gray-50">
 <p class="text-xs font-bold text-gray-400 mb-1">Total Kuantitas</p>
 <h3 class="text-xl font-bold text-teal-600">+{{ $pembelians->sum('Kuantitas') }} <span class="text-xs text-gray-400 font-medium">Unit</span></h3>
 </div>
 <div class="p-6">
 <p class="text-xs font-bold text-gray-400 mb-1">Total Pengeluaran</p>
 ...
 <td class="py-4 px-6 text-sm text-gray-500 font-medium">{{ \Carbon\Carbon::parse($item->Tgl_Pembelian)->format('d/m/Y') }}</td>
 <td class="py-4 px-6">
 ...
 <td class="py-4 px-6 text-sm text-gray-600 font-medium">{{ $item->pemasok->Nama_Pemasok ?? '-' }}</td>
 ...
 @empty
 <tr>
 <td colspan="5" class="py-12 text-center text-gray-400 italic text-sm font-medium">Tidak ada data pembelian pada periode ini</td>
 </tr>
 @endforelse
 </tbody>
 </table>
