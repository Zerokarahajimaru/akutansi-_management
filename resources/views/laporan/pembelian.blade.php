...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Total Pengeluaran -->
        <div class="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgba(169,141,102,0.08)] border border-slate-100 flex items-center justify-between group hover:border-[#3B8A7F]/20 transition-all duration-300">
            <div>
        ...
        <!-- Total Barang Masuk -->
        <div class="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgba(169,141,102,0.08)] border border-slate-100 flex items-center justify-between group hover:border-blue-200 transition-all duration-300">
            <div>
        ...
        <!-- Top Pemasok -->
        <div class="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgba(169,141,102,0.08)] border border-slate-100 flex items-center justify-between group hover:border-amber-200 transition-all duration-300">
                ...
                <thead>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-[#A98D66]/10 transition-all group">
                            <td class="py-5 px-8 text-sm text-slate-800 font-medium whitespace-nowrap sticky left-0 bg-white z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] group-hover:bg-[#F6F4F0] transition-colors">{{ $p->Tgl_Pembelian ? date('d/m/Y', strtotime($p->Tgl_Pembelian)) : '-' }}</td>
