...
<div class="space-y-8">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgba(13,148,136,0.05)] border border-slate-100 flex flex-col lg:flex-row justify-between items-center gap-6">
        <form action="{{ route('laporan.penjualan') }}" method="GET" class="w-full lg:flex-1">
        ...
        <div class="flex flex-wrap items-center gap-3 w-full lg:w-auto border-t lg:border-t-0 pt-4 lg:pt-0 border-slate-50">
            <a href="{{ route('util.export', 'penjualan') }}" class="flex-1 lg:flex-none flex items-center justify-center px-5 py-2.5 bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white border border-emerald-200 font-bold rounded-xl text-[10px] uppercase tracking-widest transition-all active:scale-95">
