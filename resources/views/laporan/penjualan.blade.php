...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(13,148,136,0.05)] border border-slate-100 overflow-hidden">
        <div class="p-8 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <form action="{{ route('laporan.penjualan') }}" method="GET" class="flex flex-wrap items-end gap-4">
                <div class="space-y-2">
    ...
    <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_20px_50px_rgba(13,148,136,0.05)] overflow-hidden">
        <div class="p-8 border-b border-slate-50 flex justify-between items-center bg-slate-50/30">
            ...
            <div class="flex gap-2">
                <a href="{{ route('util.export', 'penjualan') }}" class="flex items-center px-5 py-2.5 bg-slate-100 text-slate-600 border border-slate-200 font-bold rounded-xl text-xs uppercase tracking-widest hover:bg-slate-200 transition-all active:scale-95">
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-teal-50/30 transition-colors group">
                        <td class="py-5 px-8 text-sm text-slate-600 font-medium">{{ date('d/m/Y', strtotime($p->Tanggal_Penjualan)) }}</td>
                        <td class="py-5 px-8">
